(function ($) {
    'use strict'
    let transition = window.mt.transition; // transition兼容解决，transition.js
    ...
    function showHide($elem, options) {
        ...
        return {
            ...
            show: mode.show.bind(this,$elem),
            hide: mode.hide.bind(this,$elem),
        };
    }
